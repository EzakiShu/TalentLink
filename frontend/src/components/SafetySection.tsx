      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20 relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center opacity-5">
            <span className="text-7xl font-bold text-gray-300 tracking-widest">SAFETY & SECURITY</span>
          </div>
        ...
        {/* Safety Features Grid - Simple Clean Design */}
          ...
          {safetyFeatures.map((feature, index) => (
            ...
            >
              <div className="space-y-6">
                <div className="bg-blue-50 w-16 h-16 rounded-lg flex items-center justify-center mx-auto group-hover:bg-blue-100 transition-colors duration-300">
                ...
                <div className="bg-blue-50 rounded-lg p-3 border border-blue-100">
                  <div className="text-sm font-medium text-blue-600 mb-2 flex items-center justify-center gap-2">
                ...
                {/* Feature Badge */}
                <div className="inline-flex items-center gap-2 bg-blue-50 px-4 py-2 rounded-lg text-xs font-medium text-blue-600 border border-blue-100">
