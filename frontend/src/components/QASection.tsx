      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center opacity-5">
            <span className="text-9xl font-bold text-gray-300 tracking-widest">FAQ</span>
          </div>
        ...
        {/* Q&A Content - Direct FAQ List */}
        <div className="space-y-4 mb-20">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="bg-white rounded-lg overflow-hidden border border-gray-200 hover:border-blue-300 transition-all duration-300 shadow-sm hover:shadow-md"
            >
              <button
              ...
              >
                ...
                <div className="flex-shrink-0">
                  {openIndex === index ? (
                    <ChevronUp className="w-6 h-6 text-blue-600 group-hover:text-blue-700 transition-colors" />
                  ) : (
        ...
        {/* Contact Section - Clean White and Blue Design */}
        <div className="bg-white rounded-lg shadow-xl border border-gray-200 overflow-hidden">
          ...
          <div className="bg-blue-600 text-white text-center py-8">
            ...
            <p className="text-blue-100 mt-2 text-lg">お気軽にお問い合わせください</p>
          </div>
              ...
              <div className="text-center">
                <div className="bg-gray-50 rounded-lg p-8 hover:bg-gray-100 transition-colors duration-300 group mb-6 border border-gray-200">
                  <div className="space-y-6">
                    <div className="bg-blue-100 w-20 h-20 rounded-lg flex items-center justify-center mx-auto group-hover:bg-blue-200 transition-colors">
                    ...
                    <div className="bg-blue-50 rounded-lg p-4 border border-blue-100">
                      <div className="text-sm text-blue-600 font-medium">平均回答時間: 24時間以内</div>
                    </div>
                  </div>
                </div>
                <button className="bg-blue-600 text-white px-10 py-4 rounded-lg font-bold text-lg hover:bg-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
                  相談フォームへ
                </button>
              </div>
